...
const CrudForm = ({createData, updateData, dataToEdit, setDataToEdit}) => {
    ...
    const handleSubmit = e => {
        ...
        //utilizamos el id para identificar si creamos uno nuevo, o editamos uno
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="constellation" placeholder="Constelación" value={form.constellation} onChange={handleChange} />
